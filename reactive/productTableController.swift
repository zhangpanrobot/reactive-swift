...
//http://b-one.aa123bb.com/list_pro_common.do?app_version=1.0.1&os_type=ios&channel=OD_AppStore&uid=-1&web=1&last_round_id=0&last_weight=0




class productTable: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    @IBOutlet weak var productTableList: UITableView!
    func getProductList() {
                ...
                if response.result.value != nil {
                    ...
                    if let data = jsonObj["data"].arrayValue as [JSON]?{
                        ...
                        if(data.count > 0) {
                            ...
                            self.productTableList.reloadData()
                        } else {
                            self.hasMore = false
                        }
                    }
